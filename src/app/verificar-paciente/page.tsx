      ...
      <main className="mx-auto max-w-xl px-4 pb-8">
        ...
        {!done && (
          <div className="rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <button
              className="mt-6 flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-emerald-700 px-5 font-semibold text-white shadow-sm disabled:opacity-70 active:scale-[0.98]"
        ...
        {done && ok && (
          <>
            ...
            <button
              className="mt-6 min-h-12 w-full rounded-xl bg-emerald-700 px-5 font-semibold text-white shadow-sm active:scale-[0.98]"
              onClick={continuar}
            >
