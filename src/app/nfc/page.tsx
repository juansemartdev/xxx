      ...
      <main className="mx-auto max-w-xl px-4 pb-8">
        ...
        {validated ? (
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-sm">
            <div className="mx-auto flex h-28 w-28 items-center justify-center rounded-full bg-emerald-50 text-6xl text-emerald-700">
              ◉
            </div>
            <p className="mt-6 text-lg font-bold text-slate-900">Listo para escanear</p>
            <p className="mt-2 text-sm text-slate-500">{msg}</p>
            <button
              className="mt-7 min-h-12 w-full rounded-xl bg-emerald-700 px-5 font-semibold text-white shadow-sm active:scale-[0.98]"
              onClick={scan}
            >
              Escanear NFC
            </button>
